...
namespace DIO.Bank
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
          ...
          Console.WriteLine("Obrigado por utiliza nossos serviços.");
          Console.ReadLine();
        }
        ...
        private static void Depositar()
        {
            ...
            double valorDeposisto = double.Parse(Console.ReadLine());

            listContas[indiceConta].Depositar(valorDeposisto);
        }
        ...
        private static void InserirContas()
        {
           ...
           double esntradaSaldo = double.Parse(Console.ReadLine());
